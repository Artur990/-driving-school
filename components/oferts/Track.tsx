    ...
    <div className="cartOfert">
      <div className="p-8 sm:p-10 lg:flex-auto">
        ...
        <p className="mt-6 text-base leading-7 text-gray-600">
          ...
          jazdy kategorii C i C+E! Pod czujnym okiem doświadczonych
          instruktorów, nauczysz się bezpiecznej i pewnej jazdy, zdobywając
          niezbędne umiejętności, które otworzą przed Tobą nowe możliwości.
