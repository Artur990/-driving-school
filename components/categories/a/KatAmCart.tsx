...
const KatAmCart: FC<katACartProps> = ({}) => {
  return (
    <div className="font-sans ring-1 ring-grey-400 p-2 m-1 sm:m-7  rounded-3xl text-gray-900 antialiased bg-gray-100 min-h-screen">
      <h1 className="text-4xl text-center font-bold mb-4">Kategoria AM</h1>
        ...
        <div className="container lg:w-1/2  w-full mx-auto p-6">
          <Card title="To oferujemy:" imgSrc="/logo2.png">
            <ul className="list-disc pl-5 mb-4">
              <li className="font-medium list-disc text-red-500  ">
                <span className="text-gray-800">
                  <span className="font-semibold">Yamaha MT07</span> to motocykl
                  o wyjątkowo dynamicznych osiągach, co pozwala na płynne i
                  bezpieczne przemieszczanie się po drodze. Dodatkowo, jego
                  konstrukcja i właściwości jezdne sprawiają, że jest to
                  motocykl łatwy w prowadzeniu i dostosowaniu do indywidualnych
                  potrzeb kierowcy.
                </span>
              </li>
              <li className="font-medium list-disc text-red-500  ">
